...
{
    if(Height > pindexBest->nHeight) { return "779c6703813172725c6d660aa539ee6a3d7a9fe784c87fae7f36582e3b797058"; }
    if(Height < 0) { return "779c6703813172725c6d660aa539ee6a3d7a9fe784c87fae7f36582e3b797058"; }
    int desiredheight;
...
std::string getBlockMerkle(int Height)
{
    ...
    CBlock block;
    CBlockIndex* pblockindex = mapBlockIndex[hash];
    return pblockindex->hashMerkleRoot.ToString().substr(0,74).c_str();
}
...
{    
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " TRS");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " TRS");
    }
}
