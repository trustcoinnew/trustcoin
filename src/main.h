...
static const int LAST_POW_BLOCK = 51000; //
...
static const int64 MAX_MONEY = 5000000000 * COIN;			// 5 bil
static const int64 CIRCULATION_MONEY = MAX_MONEY;
static const double TAX_PERCENTAGE = 0.01;
static const int64 MAX_TRUST_PROOF_OF_STAKE = 0.07 * COIN;	// 7% annual interest
static const int CUTOFF_POW_BLOCK = 51000;
...
static const uint256 hashGenesisBlockOfficial("1b2b6fbc2c54295ea9e66182306fe2c285f8d69b8758430c46549469652a760e");
static const uint256 hashGenesisBlockTestNet ("1b2b6fbc2c54295ea9e66182306fe2c285f8d69b8758430c46549469652a760e");
...
public:
    ...
    std::string ToString() const
    {
        return strprintf("CBlockIndex(nprev=%p, pnext=%p, nFile=%u, nBlockPos=%-6d nHeight=%d, nTrust=%s, nMoneySupply=%s, nFlags=(%s)(%d)(%s), nStakeModifier=%016"PRI64x", nStakeModifierChecksum=%08x, hashProofOfStake=%s, prevoutStake=(%s), nStakeTime=%d merkle=%s, hashBlock=%s)",
            pprev, pnext, nFile, nBlockPos, nHeight,
            FormatMoney(nTrust).c_str(), FormatMoney(nMoneySupply).c_str(),
